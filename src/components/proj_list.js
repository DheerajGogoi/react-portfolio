exports.proj_list = [
    ...
    },
    {
        ...
        desc: "Built a simple Todo-App to demonstrate Hasura-GraphQL's serverless capabilities by implementing CRUD operations.",
        tools: [
            'React',
            'Firebase',
            'Hasura-GraphQL'
        ],
        github: 'https://github.com/DheerajGogoi/Todo-App.git',
        link: "https://todo-app-dheeraj.netlify.app/",
        inprogress: false
    },
    {
