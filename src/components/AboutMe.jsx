            ...
            <div className='container'>
                <div className='row'>
                    ...
                    <div className='col-lg-6 col-md-6 col-sm-12' data-aos='fade-up'>
                        ...
                        <a href='https://drive.google.com/file/d/1Xb-n4EJPvwT6x0JIlh7VTzb55ZSo5m-x/view?usp=sharing' target='_blank' rel='noreferrer' class="mx-2 active" style={{color: 'orange', textDecoration: 'none'}}>
