                    ...
                    <div className='row'>
                        <div className='col-lg-6 col-md-6 col-sm-12' data-aos="fade-up">
                            <p className='home-content' style={{color: 'white', fontFamily: 'Quicksand'}}>
                                ...
                                <p className='my-about'>I am an aspiring Software Developement Engineer who loves building real world peojects.</p>
                                <a href="#contactMe" style={{textDecoration: 'none'}}><p className='my-contact' data-aos="fade-up">Contact Me <span>&#8594;</span></p></a>
