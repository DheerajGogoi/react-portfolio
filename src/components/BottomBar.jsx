            ...
            <div className='bottom-container container'>
                <center>
                    <div className='row' style={{fontFamily: 'Sans serif Pro'}}>
                        <div className='col-lg-4 col-md-4 col-sm-12 copy-right'>©2024 Dheeraj Gogoi. All rights reserved</div>
                        ...
                        <div className='col-lg-4 col-md-4 col-sm-12 link-icons'>
                            ...
                            <a href='https://www.instagram.com/dheeraj_gogoi_' target='_/blank' style={{color: 'white'}}><i class="fab fa-instagram icons-logo"></i></a>
                        </div>
                    </div>
                </center>
            </div>
